...
FROM 339388639205.dkr.ecr.ap-northeast-1.amazonaws.com/sbcntr-base:golang-1.16.8-alpine3.13 AS build-env
ENV GO111MODULE=on
RUN mkdir /app
WORKDIR /app
...
FROM 339388639205.dkr.ecr.ap-northeast-1.amazonaws.com/sbcntr-base:alpine-3.14
